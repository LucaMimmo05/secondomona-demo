# Documentazione Progetto SecondoMona Demo
...
### API Persone
- `GET /api/persone`: Recupera tutte le persone
- `GET /api/persone/{id}`: Recupera una persona specifica
- `POST /api/persone/dipendenti`: Crea un nuovo dipendente
- `POST /api/persone/visitatori`: Crea un nuovo visitatore
- `GET /api/persone/visitatori`: Recupera tutti i visitatori
- `GET /api/persone/dipendenti`: Recupera tutti i dipendenti
...
- `Visitatore`: Accesso molto limitato
...
Il frontend del sistema è implementato utilizzando HTML, CSS e JavaScript con template Qute. Le principali pagine sono:

- `/assegna-badge.html`: Interfaccia per la gestione dei badge
- Altre pagine per la gestione di visitatori, dipendenti e visite

Per maggiori dettagli sulle API, consultare la documentazione specifica in `/templates/pub/api-documentation.md`.
